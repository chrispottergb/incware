...
export const competitors: Competitor[] = [
  ...
  {
    name: "EntityKeeper",
    positioning: "Mid-market entity management + org-chart with compliance deadline automation.",
    buyer: "In-house legal, family offices, 10–500-entity companies",
    pricing: "Public — $465/mo (up to 100 entities); from ~$100/mo for smaller tiers",
    strengths: ["Affordable for mid-market", "Visual org charts", "Compliance calendar"],
    weaknesses: ["No statute-cited resolutions", "Light document generation", "No cap table / minute book depth", "Not built for law firms managing client books"],
    threat: "Medium",
  },
  {
    name: "MinuteBox",
    positioning: "Canadian-rooted minute-book platform now expanding into the US; the closest direct competitor.",
    buyer: "Law firms managing client minute books (mostly Canada)",
    pricing: "Quote-based; firm-tier subscriptions",
    strengths: ["Purpose-built for firm workflow", "Document generation", "Compliance alerts"],
    weaknesses: ["Canadian statute heritage — US statute coverage thin", "No AI drafting", "Limited Non-Profit + cap-table depth", "Small US footprint"],
    threat: "Medium",
  },
  {
